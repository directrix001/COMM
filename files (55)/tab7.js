  ...
  function buildHTML() {
    return `
      ...
      <div class="upload-zone" id="t7-dropzone">
        ...
        <span><strong>Drag &amp; drop</strong> or <strong id="t7-browse-link" style="color:var(--blue);cursor:pointer">browse</strong> — .pptx / .ppt</span>
        <span id="t7-file-name" style="margin-left:auto;font-size:.72rem;color:var(--blue)"></span>
      </div>
