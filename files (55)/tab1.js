...
(function () {
  ...
  function buildHTML() {
    return `
      ...
      <div class="upload-zone" id="t1-dropzone">
        ...
        <span><strong>Drag &amp; drop</strong> or <strong id="t1-browse-link" style="color:var(--blue);cursor:pointer;">browse</strong> — .xlsx / .xls</span>
        <span id="t1-file-name" style="margin-left:auto;font-size:.72rem;color:var(--blue)"></span>
      </div>
  ...
  function setFileName(name) {
    const el = document.getElementById('t1-file-name');
